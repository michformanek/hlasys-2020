...
class User extends \App\Model\Database\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Model\\Database\\Entity\\User' . "\0" . 'username', '' . "\0" . 'App\\Model\\Database\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Model\\Database\\Entity\\User' . "\0" . 'role', '' . "\0" . 'App\\Model\\Database\\Entity\\User' . "\0" . 'id'];
        }
